<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (empty($_POST["name"]) || empty($_POST["phone_number"])) {
      ...
      $statement = $conn->prepare("UPDATE abm SET name=:name, phone_number=:phone_number WHERE id=:id")->execute([
        ":id" => $id,
        ":name" => $_POST["name"],
  ...
  <main>
    <div class="container pt-5">
      <div class="row justify-content-center">
        <div class="col-md-8">
          <div class="card">
            <div class="card-header">Modificar contacto</div>
            <div class="card-body">
              <?php if($error):?>
              ...
              <form method="post" >
                <div class="mb-3 row">
                  ...
                  <div class="col-md-6">
                    <input value="<?= $name?>" type="text" class="form-control" id="name" name="name" require autocomplete="number">
                  </div>
                </div>
                <div class="mb-3 row">
                  <div class="col-md-6 col-form-label text-md-end">
                  ...
                  <div class="col-md-6">
                    <input value="<?= $phone_number?>" type="tel" class="form-control" id="phone_number" name="phone_number" require autocomplete="number">
                  </div>
                </div>
                <div class="mb-3 row">
